...
const Table = (props) => {
                        ...
                        if(r.name===props.room){
                            ...
                            for(const t of r.tables){
                                if(t.name === props.table.name){
                                    ...
                                    if(tipo === "new" || tipo === "extend"){
                                        getTables[indexTable].reservation = reservation
                                        getRooms[indexRoom] = {
                                            tables:getTables,
                                            name:parseInt(r.name),
                                            favorites:getRooms[indexRoom].favorites
                                        }
                                    }
                                    else if(tipo === "checkin"){
                                        getTables[indexTable].reservation = {
                                            endTime: getTables[indexTable].reservation.endTime,
                                            initTime: getTables[indexTable].reservation.initTime,
                                            istID: getTables[indexTable].reservation.istID,
                                            checked:true
                                        }
                                        getRooms[indexRoom] = {
                                            tables:getTables,
    ...
    return (
        <div className="table" hidden={props.table?false:true}>
            <p className="table-bye" onClick={() => { props.callback(); updateReynaud(true); updateCancel(true); updateIstID("")}}>X</p>
            {/* MESA LIMPA */}
            <div className="new" hidden={props.table?(props.table.reservation.endTime===null && props.table.dirty===false)?false:true:true}>
             ...
             <div className="new" hidden={props.table?(props.table.reservation.endTime===null && props.table.dirty===true)?false:true:true}>
                <div className="new-top" >
                    <div className="new-left">
                        <div className="new-id">
                            <p className="new-id-text">IST ID</p>
                ...
                <div className="new-bot">
                    <div className="new-bot-div">
                        <p className="new-bot-button" onClick={() => reservationHandler("new")}>Reservar</p>
            ...
            {/* MESA NAO LIMPA SEM CHECK-IN */}
            <div hidden={props.table?(props.table.reservation.endTime!==null && props.table.dirty===true && props.table.reservation.checked === false)?false:true:true}>
            <div className="new-top" >
                    <div className="new-left">
                        <div style={{display:"flex"}}>
                ...
                <div className="extend" hidden={cancel}>
                        <p style={{fontSize: "15px", fontWeight:"600"}}>Tem a certeza que pretende CANCELAR?</p>
            ...
            <div className="new-top" >
                ...
                <div className="extend" hidden={cancel}>
                        <p style={{fontSize: "15px", fontWeight:"600"}}>Tem a certeza que pretende SAIR?</p>
                        <div className="new-add-time-extend" style={{justifyContent: "space-around", marginTop: "10px"}}>
                            <p className="new-bot-button-No" onClick={() => updateCancel(true)}>NÃO</p>
